...
import net.mcreator.dfb.init.ConfectionsModVillagerProfessions;
import net.mcreator.dfb.init.ConfectionsModTabs;
...
@Mod("confections")
public class ConfectionsMod {
	public static final Logger LOGGER = LogManager.getLogger(ConfectionsMod.class);
	public static final String MODID = "confections";

	public ConfectionsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		ConfectionsModItems.register(modEventBus);

		ConfectionsModTabs.REGISTRY.register(modEventBus);

		ConfectionsModVillagerProfessions.PROFESSIONS.register(modEventBus);
